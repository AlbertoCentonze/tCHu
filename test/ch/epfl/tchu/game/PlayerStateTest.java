...
public class PlayerStateTest {
    ...
    void ticketPointsNormalTest(){
        ...
        assertEquals(5, player.ticketPoints());
    }
    ...
    void ticketPointsWithNoTicketTest(){
        ...
        assertEquals(0, player.ticketPoints());
    }
    ...
    void playerStateWithAddedTicketAddsTicket() {
        var tickets = new ChMapTest().ALL_TICKETS;
    ...
    private static final class ChMapTest {
        //region Stations
