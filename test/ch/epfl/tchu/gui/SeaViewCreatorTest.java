...
public final class SeaViewCreatorTest extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ObjectProperty<ActionHandlers.ClaimRouteHandler> claimRoute =
                new SimpleObjectProperty<>(SeaViewCreatorTest::claimRoute);
        ObjectProperty<ActionHandlers.DrawTicketsHandler> drawTickets =
                new SimpleObjectProperty<>(SeaViewCreatorTest::drawTickets);
        ObjectProperty<ActionHandlers.DrawCardHandler> drawCard =
                new SimpleObjectProperty<>(SeaViewCreatorTest::drawCard);

        Node seaView = SeaViewCreator.createSeaView(gameState, claimRoute);
        ...
        BorderPane mainPane =
                new BorderPane(seaView, null, cardsView, handView, null);
